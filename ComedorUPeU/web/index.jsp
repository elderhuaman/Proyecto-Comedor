        ...
        <div class="header-top">
            <div class="header-nav">
                ...
                <div class="head-top-text">
                    <div class="container">
                        <h2>Comedor Universiatario UPeU</h2>
                        <p>Bridamos calidad para las personas.<br> lo mejor podras encontrsar aqui</p>
                        <a class="btn btn-default hd-more" href="#" role="button">Revisar</a>
                    </div>
                </div>
            </div>
         <!--trainers-->
